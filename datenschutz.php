...
<section class="py-16 bg-white">
  <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-700 text-sm leading-relaxed space-y-8">
    ...
    <div>
      <h2 class="text-navy font-bold text-xl mb-3">3. Zweck der Datenbearbeitung</h2>
      <p>
    ...
    <div>
      <h2 class="text-navy font-bold text-xl mb-3">4. Aufbewahrung</h2>
      <p>
    ...
    <div>
      <h2 class="text-navy font-bold text-xl mb-3">5. Ihre Rechte</h2>
      <p>
    ...
    <div>
      <h2 class="text-navy font-bold text-xl mb-3">6. SSL-Verschlüsselung</h2>
      <p>
    ...
    <div>
      <h2 class="text-navy font-bold text-xl mb-3">7. Änderungen dieser Datenschutzerklärung</h2>
      <p>
