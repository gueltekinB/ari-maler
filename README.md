...
Marketing website for Ari Maler GmbH (Malerarbeiten & Sanierungen, Basel), built with React + Vite and `react-router-dom`.
...
- `src/data/` — service copy and before/after reference photo pairs
